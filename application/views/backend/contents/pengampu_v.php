                    ...
                    <div id="table-data">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <button id="create" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah Pengampu</button>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    var site_url = site_url() + 'pengampu/';
    ...
    function form_view() {
        ...
        $('.modal-title').text('View Pengampu');
    }
    ...
    function view_data(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('p#idMakul').html(data.idMakul);
                $('p#idDosen').html(data.idDosen);
                $('p#idKelas').html(data.idKelas);
                $('p#idTahun').html(data.idTahun);
            }
        });
    }
    ...
    function update_data(id) {
        $.ajax({
            ...
            success: function(data) {
                $(".chosen-select").chosen("destroy");
                form_data();
                $('.modal-title').text('Update Pengampu');
