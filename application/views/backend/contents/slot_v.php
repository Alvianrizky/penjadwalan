                    ...
                    <div id="table-data">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <button id="create" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah Slot Waktu</button>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    var site_url = site_url() + 'slotwaktu/';
        ...
        $('#create').click(function() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    form_data();
                    $('.modal-title').text('Tambah Slot Waktu');
    ...
    function table_data() {
        ...
        $('#myModal').modal('hide');
        $('.card-title').text('Slot Waktu List');
    }
    ...
    function form_view() {
        ...
        $('.modal-title').text('View Slot Waktu');
    }
    ...
    function view_data(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('p#hari').html(data.hari);
                $('p#sesi').html(data.sesi);
                $('p#idRuang').html(data.idRuang);
            }
        });
    }
    ...
    function update_data(id) {
        $.ajax({
            ...
            success: function(data) {
                $(".chosen-select").chosen("destroy");
                form_data();
                $('.modal-title').text('Update Slot Waktu');
