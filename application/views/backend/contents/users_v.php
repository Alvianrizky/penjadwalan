                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label>Username</label>
                                                            <?php
                                                            echo form_dropdown('username', $guru, isset($username) ? set_value('username', $username) : '1', 'class="form-control chosen-select" id="username"');
                                                            ?>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Email</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label>Username</label>
                                                            <?php
                                                            echo form_dropdown('username', $siswa, isset($username) ? set_value('username', $username) : '1', 'class="form-control chosen-select" id="username"');
                                                            ?>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Email</label>
