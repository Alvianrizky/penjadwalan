                    ...
                    <div id="table-data">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <button id="create" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah Dosen</button>
                                    </div>
                                </div>
                            </div>
    ...
    function view_data(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('p#nip').html(data.nip);
                $('p#namaDosen').html(data.namaDosen);
            }
        });
    }
