                    ...
                    <div id="table-data">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <button id="create" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah Mata Kuliah</button>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
        ...
        $('#create').click(function() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#namaMakul').html(data.namaMakul);
                    $('#jenis').html(data.jenis);
                    $('#jumlahSks').html(data.jumlahSks);
    ...
    function table_data() {
        ...
        $('#myModal').modal('hide');
        $('.card-title').text('Mata Kuliah List');
    }
    ...
    function form_view() {
        ...
        $('.modal-title').text('View Mata Kuliah');
    }
    ...
    function view_data(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('p#namaMakul').html(data.namaMakul);
                $('p#jenis').html(data.jenis);
                $('p#jumlahSks').html(data.jumlahSks);
            }
        });
    }
    ...
    function update_data(id) {
        $.ajax({
            ...
            success: function(data) {
                $(".chosen-select").chosen("destroy");
                form_data();
                $('.modal-title').text('Update Mata Kuliah');
